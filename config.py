...
WALL_POS = [
    (0.40*WIN_SIZE[0], SB_POS[3] + 0.20*WIN_SIZE[1]),
    (0.90*WIN_SIZE[0], SB_POS[3] + 0.20*WIN_SIZE[1]),
    (0.15*WIN_SIZE[0], SB_POS[3] + 0.45*WIN_SIZE[1]),
    (0.55*WIN_SIZE[0], SB_POS[3] + 0.45*WIN_SIZE[1]),
    (0.70*WIN_SIZE[0], SB_POS[3] + 0.70*WIN_SIZE[1]),
    (0.05*WIN_SIZE[0], SB_POS[3] + 0.70*WIN_SIZE[1]),
]
